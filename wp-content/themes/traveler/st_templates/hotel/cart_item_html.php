    ...
    <ul class="booking-item-payment-details">
        ...
        <li>
            ...
            <ul class="booking-item-payment-price">
                ...
                ?>
                    <li>
                        <p class="booking-item-payment-price-title">
                            <?php echo date(TravelHelper::getDateFormat(),strtotime($v['start'])); ?>
                            <i class="fa fa-arrow-right "></i>
                            <?php echo date(TravelHelper::getDateFormat(),strtotime($v['end'])) ?>
                        </p>
                        <p class="booking-item-payment-price-amount">
                            <?php echo (TravelHelper::format_money($v['price'])) ?>/<small><?php st_the_language('per_night')?></small>
                        </p>
                    </li>
                <?php  endforeach;
                    } ?>
                ...
                <li>
                    <p class="booking-item-payment-price-title"><?php _e("Room number",ST_TEXTDOMAIN) ?></p>
                    <p class="booking-item-payment-price-amount"><?php echo esc_html($item['number']);?></p>
                </li>
