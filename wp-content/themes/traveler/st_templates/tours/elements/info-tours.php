        ...
        <div class="col-md-6">
            <?php if($type_tour == 'specific_date'){ ?>
                <div class="package-info">
                    ...
                    <?php
                    $check_in = date('m/d/Y', strtotime(get_post_meta(get_the_ID() , 'check_in' ,true)));
                    $check_out = date('m/d/Y', strtotime(get_post_meta(get_the_ID() , 'check_out' ,true)));
                    $date = date(TravelHelper::getDateFormat(),strtotime($check_in)).' <i class="fa fa-long-arrow-right"></i> '.date(TravelHelper::getDateFormat(), strtotime($check_out));
            ...
            <?php }else{ ?>
                <div class="package-info">
                    ...
                    if(empty($duration_day))$duration_day=1;
                    ?>
                    ...
                    <div class="div_book">
                        <div class="div_book_tour">
                            ...
                            <?php if($type_tour == 'daily_tour'){ ?>
                                ...
                                <input name="check_in" data-date-format="<?php echo TravelHelper::getDateFormatJs(); ?>"   type="text" value="" class="tour_book_date form-control" required placeholder="<?php echo TravelHelper::getDateFormatJs(); ?>" />
                                <!--<select name="duration" class="form-control">
                                    <?php
/*                                    for($i=0 ; $i < $duration_day ; $i++ ){
