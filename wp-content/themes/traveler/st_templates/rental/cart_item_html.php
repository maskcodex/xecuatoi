    ...
    <ul class="booking-item-payment-details">
        <li>
            ...
            <div class="booking-item-payment-date">
                <p class="booking-item-payment-date-day"><?php echo date_i18n('M, d',(float)$check_in)?></p>
                <p class="booking-item-payment-date-weekday"><?php echo date_i18n('l',(float)$check_in) ?></p>
            </div>
            <i class="fa fa-arrow-right booking-item-payment-date-separator"></i>
            <div class="booking-item-payment-date">
                <p class="booking-item-payment-date-day"><?php echo date_i18n('M, d',(float)$check_out)?></p>
                <p class="booking-item-payment-date-weekday"><?php echo date_i18n('l',(float)$check_out) ?></p>
            </div>
        </li>
        <li>
