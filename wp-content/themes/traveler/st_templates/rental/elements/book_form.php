...
<div class="booking-item-dates-change">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group form-group-icon-left"><i class="fa fa-calendar input-icon"></i>
                        ...
                        <input required="required" placeholder="<?php echo TravelHelper::getDateFormatJs(); ?>" value="<?php echo STInput::post('start', STInput::get('start')); ?>" class="form-control required" name="start" type="text" />
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group form-group-icon-left"><i class="fa fa-calendar input-icon"></i>
                        <label><?php st_the_language('rental_check_out')?></label>
                        <input required="required" placeholder="<?php echo TravelHelper::getDateFormatJs(); ?>" value="<?php echo STInput::post('end', STInput::get('end')); ?>" class="form-control required" name="end" type="text" />
                    </div>
                </div>
            </div>
        </div>
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                $old=STInput::post('adult',STInput::get('adult_num', 1));
