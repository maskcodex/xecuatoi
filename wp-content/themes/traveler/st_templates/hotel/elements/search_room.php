            ...
            <form>
                ...
                <div class="input-daterange" data-date-format="<?php echo TravelHelper::getDateFormatJs(); ?>">
                    <div class="form-group form-group-icon-left"><i class="fa fa-calendar input-icon input-icon-hightlight"></i>
                        ...
                        <input placeholder="<?php echo TravelHelper::getDateFormatJs(); ?>" class="form-control" value="<?php echo STInput::get('start') ?>" name="start" type="text">
                    </div>
                    <div class="form-group form-group-icon-left"><i class="fa fa-calendar input-icon input-icon-hightlight"></i>
                        <label><?php st_the_language('check_out')?></label>
                        <input placeholder="<?php echo TravelHelper::getDateFormatJs(); ?>" class="form-control" value="<?php echo STInput::get('end') ?>" name="end" type="text">
                    </div>
                </div>
                ...
                <div class="input-daterange" data-date-format="<?php echo TravelHelper::getDateFormatJs(); ?>">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group form-group-icon-left"><i class="fa fa-calendar input-icon input-icon-hightlight"></i>
                                <label><?php st_the_language('check_out')?></label>
                                <input placeholder="<?php echo TravelHelper::getDateFormatJs(); ?>" value="<?php echo STInput::get('end') ?>" class="form-control" name="end" type="text">
                            </div>
                        </div>
                    </div>
                </div>
