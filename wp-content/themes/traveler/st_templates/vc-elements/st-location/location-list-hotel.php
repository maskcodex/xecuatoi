...
if ($style == 'list') {
    if ($query->have_posts()) {
        echo '<ul class="booking-list loop-hotel style_list loop-hotel-location">';
    ...
    ?>
    <div class="row row-wrap loop_hotel loop_grid_hotel loop_grid_hotel_location style_box">
