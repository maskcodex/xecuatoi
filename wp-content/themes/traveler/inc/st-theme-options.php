...
$custom_settings = array(
    ...
    'settings' => array(
        ...
        array(
            'id'      => 'enable_user_nav' ,
            'label'   => __( 'Enable User Nav' , ST_TEXTDOMAIN ) ,
            'type'    => 'on-off' ,
            'section' => 'option_general' ,
            'std'     => 'on'
        ) ,
        ...
        array(
            ...
            'std'     => '{mm}/{dd}/{yyyy}' ,
            'section' => 'option_advance' ,
            'desc'    => __( 'The date format, combination of d, dd, D, DD, m, mm, M, MM, yy, yyyy. It is surrounded by <code>\'{}\'</code>. Ex: {dd}/{mm}/{yyyy}.
                <ul>
        ...
        array(
            'id'      => 'is_guest_booking' ,
            'label'   => __( 'Turn off Guest Booking' , ST_TEXTDOMAIN ) ,
            'desc'    => __( 'Turn off Guest Booking.' , ST_TEXTDOMAIN ) ,
            'section' => 'option_booking' ,
            'type'    => 'on-off' ,
            'std'     => 'off'
        ) ,
        ...
        array(
            ...
            'label'   => __( "Which Price is showing in listing page" , ST_TEXTDOMAIN ) ,
            'type'    => 'select' ,
            'choices' => array(
                array(
                    'value' => 'avg_price' ,
        ...
        array(
            ...
            'label'   => __( 'Booking Days included check-in day' , ST_TEXTDOMAIN ) ,
            'type'    => 'on-off' ,
            'std'     => 'off' ,
            'section' => 'option_car' ,
        ) ,
        array(
            ...
            'label'   => __( 'Show featured car in top of search results' , ST_TEXTDOMAIN ) ,
            'type'    => 'on-off' ,
            'std'     => 'off' ,
            'section' => 'option_car'
        ) ,
        ...
        array(
            'id'        => 'car_review_stats' ,
            'label'     => __( 'Car Review Stats' , ST_TEXTDOMAIN ) ,
            'desc'      => __( 'Car Review Stats' , ST_TEXTDOMAIN ) ,
            'type'      => 'list-item' ,
            'section'   => 'option_car' ,
            'condition' => 'hotel_review:is(on)' ,
            'settings'  => array(
