(function($){
	...
	var car_rentals = {
			...
			if (typeof $('#car_booking_form_datepicker') !== 'undefined') {
				...
				$('#car_booking_form_datepicker').datepicker({
					...
					onSelect: function(dateText, inst) {
						...
						var date1 = null;
						if ($("#car_booking_form_date_from").val()) {
							date1 = new Date(parseInt($("#car_booking_form_date_from").val()));
						}
						var date2 = null;
						if ($("#car_booking_form_date_to").val()) {
							date2 = new Date(parseInt($("#car_booking_form_date_to").val()));
						}
						...
						if (!date1 || date2 || (date1 && date1.toString() == selectedUtcDate.toString())) {
							...
							{
								date1 = new Date(parseInt($("#car_booking_form_date_from").val()));
								date2 = new Date(selectedUtcTime);
		...
		processCarRentalBooking: function () {
			...
			var selectedDateFrom = new Date(parseInt($("#car_booking_form_date_from").val()));
			var selectedDateTo = new Date(parseInt($("#car_booking_form_date_to").val()));
			
			selectedDateFrom = car_rentals.convertUTCDateToLocalDate(selectedDateFrom);
			selectedDateTo = car_rentals.convertUTCDateToLocalDate(selectedDateTo);		
			...
			var d1 =new Date(parseInt($("#car_booking_form_date_from").val()));
			var d2 =new Date(parseInt($("#car_booking_form_date_to").val()));       
