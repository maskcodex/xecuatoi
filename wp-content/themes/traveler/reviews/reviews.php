...
<div id="comments" class="comments-area">
    ...
    <?php endif; // have_comments() ?>
        ...
        <?php endif;?>
            ...
            if (is_user_logged_in() || STReview::check_review_without_login()):                
                ...
                echo '<div class="box bg-gray">';
                echo sprintf( st_get_language('you_must').'<a href="%s">'.__('log in ',ST_TEXTDOMAIN).'</a>'.st_get_language('to_write_review'),get_permalink(st()->get_option('user_login_page')));
                echo '</div>';
            endif;       
