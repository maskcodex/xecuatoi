                        ...
                        <div class="postbox">
                            ...
                            <div class="inside">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="controls">
                                        <select name="type_price" id="activity_type_price">
                                            <option <?php selected(get_post_meta($order,'type_price',true),'activity_price')?> value="tour_price"><?php _e('Price / Activity',ST_TEXTDOMAIN) ?></option>
                                ...
                                <div class="form-row type_price_activity_price">
                                ...
                                <div class="form-row type_price_people_price">
                                    <label class="form-label" for=""><?php _e('Number of Children',ST_TEXTDOMAIN)?></label>
                                    <div class="controls">
