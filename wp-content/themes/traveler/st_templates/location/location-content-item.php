		...
		<a class="hover-img" href="<?php echo esc_url($link) ; ?>">
			...
			<div class="hover-inner hover-inner-block hover-inner-bottom hover-inner-bg-black hover-hold">
				<div class="text-small">
					...
					<p><?php echo ($reviews>=1)? esc_attr($reviews)." reviews" : "0 review"  ;?></p>
					<p class="mb0"><?php echo ($offers >=1) ? esc_attr($offers)." offers " : "0 offer" ;   ?> from <?php echo TravelHelper::format_money( $min_max_price['price_min'] ) ?></p>
				</div>
			</div>
		</a>
	</div>
