                        ...
                        <div class="row">
                            <div class="col-md-3">
                                ...
                                if(isset($cart_item['st_booking_data']) and !empty($cart_item['st_booking_data']))
                                {
                                    ...
                                    echo get_the_post_thumbnail($booking_id);
                            ...
                            <div class="col-md-5">
                                ...
                                <?php
                                    if(isset($cart_item['st_booking_data']) and !empty($cart_item['st_booking_data']))
                                    {
                                        ...
                                        if(isset($st_booking_data['deposit_money']))
                                        {
                                            ?>
                                                <p class="booking-item-description">
                                                    <?php printf(__('Deposit %s',ST_TEXTDOMAIN),$st_booking_data['deposit_money']['type']) ?>:
                                                    <?php
                                                    switch($st_booking_data['deposit_money']['type']){
                                                        case "percent":
                                                            echo $st_booking_data['deposit_money']['amount'].' %';
                                                            break;
                                                        case "amount":
                                                            echo TravelHelper::format_money($st_booking_data['deposit_money']['amount']);
                                                            break;
                                                    ...
                                                    <?php echo TravelHelper::format_money($st_booking_data['deposit_money']['old_price'])?>
