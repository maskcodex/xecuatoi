...
<div class="wrap woocommerce">
    ...
    <h2><?php _e( 'Amenities', ST_TEXTDOMAIN ) ?></h2>
    <br class="clear" />
                    ...
                    if ( $attribute_taxonomies and !empty($attribute_taxonomies) ) :
                        foreach ($attribute_taxonomies as $tax=>$value) :
                            ...
                            <td><a href="edit-tags.php?taxonomy=<?php echo esc_html($tax); ?>"><?php echo esc_html( $value['name'] ); ?></a>
                                ...
                                <div class="row-actions"><span class="edit"><a href="<?php echo esc_url( add_query_arg('edit', $tax) ); ?>"><?php _e( 'Edit', ST_TEXTDOMAIN ); ?></a> | </span><span class="delete"><a class="delete" href="<?php echo esc_url( wp_nonce_url( add_query_arg('delete', $tax), 'st_delete_attribute_' . $tax ) ); ?>"><?php _e( 'Delete', ST_TEXTDOMAIN ); ?></a></span></div>
                            </td>
