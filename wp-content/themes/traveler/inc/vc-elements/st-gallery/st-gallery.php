    ...
    if(!function_exists('st_vc_gallery')){
        function st_vc_gallery($attr,$content=false)
        {
            ...
            foreach ($list as $k=>$v){
                ...
                $image_src=wp_get_attachment_image_src($v,'full');
                ...
                $txt .= '<div class="col-md-' . $col . '">
                        <a class="hover-img popup-gallery-image" href="' .$image_src_raw. '" data-effect="'.$st_effect.'">
                           '.wp_get_attachment_image($v,$params).'
