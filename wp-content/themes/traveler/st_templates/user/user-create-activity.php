...
<form action="" method="post" enctype="multipart/form-data">
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="form-group form-group-icon-left">
                ...
                <input type="text" data-date-format="<?php echo TravelHelper::getDateFormatJs(); ?>" name="check_in" class="date-pick form-control">
                <div class="st_msg console_msg_id_location"></div>
            </div>
        </div>
        <div class="col-md-6">
            <div class="form-group form-group-icon-left">
                ...
                <input type="text" data-date-format="<?php echo TravelHelper::getDateFormatJs(); ?>" name="check_out" class="date-pick form-control">
                <div class="st_msg console_msg_address"></div>
            </div>
        </div>
        <div class="col-md-6">
    ...
    <h4><?php st_the_language('user_create_activity_price') ?></h4><div class="row">
        <div class="col-md-12">
            <div class="form-group form-group-icon-left">
                <i class="fa  fa-cogs input-icon input-icon-hightlight"></i>
                <label><?php _e("Type Price",ST_TEXTDOMAIN) ?></label>
                <select id="type_price" name="type_price" class="form-control">
                    <option selected="selected" value="activity_price"><?php _e("Price / Activity",ST_TEXTDOMAIN )?></option>
