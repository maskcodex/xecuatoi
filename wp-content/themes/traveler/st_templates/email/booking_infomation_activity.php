...
">
                            ...
                            <p><strong><?php st_the_language('activity') ?> :</strong> <a target="_blank" href="<?php  echo get_the_permalink($object_id)?>"><?php  echo get_the_title($object_id)?></a> </p>
                            ...
                            <?php }else{ ?>
                                <p><strong><?php st_the_language('booking_number') ?></strong> <?php echo get_post_meta($object_id,'item_number',true)?></p>
                                <p><strong><?php st_the_language('booking_price') ?></strong> <?php
                                    $price= get_post_meta($object_id,'item_price',true);
                                    echo TravelHelper::format_money($price);
                                    ?></p>
                            <?php } ?>
                            <p><strong><?php st_the_language('booking_check_in') ?></strong> <?php echo @date(get_option('date_format'),strtotime(get_post_meta($order_item_id,'check_in',true))) ?></p>
                            <p><strong><?php st_the_language('booking_check_out') ?></strong> <?php echo @date(get_option('date_format'),strtotime(get_post_meta($order_item_id,'check_out',true))) ?></p>
                        </td>
                    </tr>
                <?php
